...
class VideoStreamerStub(object):
    ...
    def __init__(self, channel):
        ...
        self.StreamFrames = channel.unary_stream(
                '/video.VideoStreamer/StreamFrames',
        ...
        self.HealthCheck = channel.unary_unary(
                '/video.VideoStreamer/HealthCheck',
                request_serializer=video__pb2.HealthCheckReq.SerializeToString,
                response_deserializer=video__pb2.HealthCheckReply.FromString,
                _registered_method=True)
...
def add_VideoStreamerServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'HealthCheck': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=video__pb2.HealthCheckReq.FromString,
                    response_serializer=video__pb2.HealthCheckReply.SerializeToString,
            ),
    }
...
class VideoStreamer(object):
    ...
    def HealthCheck(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/video.VideoStreamer/HealthCheck',
            video__pb2.HealthCheckReq.SerializeToString,
            video__pb2.HealthCheckReply.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
